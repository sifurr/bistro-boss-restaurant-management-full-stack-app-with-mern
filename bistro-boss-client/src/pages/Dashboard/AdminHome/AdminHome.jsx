...
import { FaAddressBook, FaDollarSign, FaListAlt, FaUsers } from 'react-icons/fa'
import {
    BarChart, Bar, Cell, XAxis, YAxis, CartesianGrid,
    PieChart, Pie, Sector, ResponsiveContainer, Legend,
} from 'recharts';
...
const AdminHome = () => {
    ...
    const pieCharData = chartData.map(data => {
        ...
        <div>
            ...
            <div>
                <div className="stats shadow">
                    ...
                    <div className="stat">
                        <div className="stat-figure text-secondary">
                            <FaAddressBook className="text-4xl"></FaAddressBook>
                        </div>
